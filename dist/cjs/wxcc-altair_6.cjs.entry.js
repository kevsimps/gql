...
const PageControls = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '25e29195bcc21f14f1179de524360f437002c743', class: "controls" }, index.h("span", { key: 'c69713131e0ed6acf64913aa4fe153f2dd707164', id: "back", onClick: this.onBack.bind(this), class: "nav btn" }, "Back"), index.h("span", { key: '69e6eb74ee56da45455fc439b8c66b179907b9b9', id: "tools", class: "mag btn" }, "Tools"), index.h("div", { key: 'c4fc126e1e23caba2d5b0ea282eb2f6d73b4ab31', class: "tools" }, index.h("span", { key: 'ce746b81f7387b9a6a452c8d4f130b04e86c73d3', onClick: this.onTimeWidget.bind(this) }, "Time Widget"), index.h("span", { key: 'fd935b97295f3fc10fbc96f4366aeed90f26582e', onClick: () => { this.vodTog.emit(); } }, "Show Video"), index.h("span", { key: '13e3654cf39527b5a71c33ff879be4cbafc7eb46', onClick: () => { this.wxccAuthPop.emit(); } }, "Authorization")), index.h("span", { key: '30fd6be543ebc79d7e6986447069f9fe53f98b84', class: "btn", id: "guide", onClick: this.onToggleGuide.bind(this) }, "Guide"), index.h("span", { key: '8229ada14838478cc1ce018d97689f637fbc19f5', id: "next", onClick: this.onNext.bind(this), class: "nav btn" }, "Next")));
    }
};
