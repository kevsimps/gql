...
const SideDrawer = class {
    ...
    render() {
        let mainContent = this.content || index.h("slot", { key: 'bb6903df9a962ca9f220e98d6ad01b590222debf' });
        if (this.showNav) {
            mainContent = index.h("ul", { key: '21c9d1827b3b48e359505486166870dd0cd62cc6', class: "nav" }, this.lessons.map(lesson => (index.h("li", { class: "nav", onClick: this.onChoice.bind(this, lesson.url) }, index.h("strong", null, lesson.title)))));
        }
        return [
            // <div class="backdrop" onClick={this.onCloseDrawer.bind(this)}/>,
            index.h("aside", { key: '4cf1062b9497a1d24e6c4056d82792f42eb730c2' }, index.h("header", { key: '10dba1a44be38838fa28107fec8cd74a9b7d647a' }, index.h("h1", { key: '7eb357f0bae53590aacba9cec971669d724dca8d', class: "post-title" }, this.currentPage || this.arttitle)), index.h("section", { key: 'e33c555a3b1b4f594442048b07d1e9da3058763a', id: "tabs" }, index.h("button", { key: '7532fb5260caffd3c4db5d0b8a2eaab3da218212', class: !this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "lesson") }, "Lesson"), index.h("button", { key: '01bf4696f1004032b69fb897634c1e7df7f6e666', class: this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "nav") }, "Navigation")), index.h("main", { key: 'dd6bee015563e7c31d3426e6bd5665e4ab7c1865' }, mainContent))
        ];
    }
};
...
const PageControls = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '25e29195bcc21f14f1179de524360f437002c743', class: "controls" }, index.h("span", { key: 'c69713131e0ed6acf64913aa4fe153f2dd707164', id: "back", onClick: this.onBack.bind(this), class: "nav btn" }, "Back"), index.h("span", { key: '69e6eb74ee56da45455fc439b8c66b179907b9b9', id: "tools", class: "mag btn" }, "Tools"), index.h("div", { key: 'c4fc126e1e23caba2d5b0ea282eb2f6d73b4ab31', class: "tools" }, index.h("span", { key: 'ce746b81f7387b9a6a452c8d4f130b04e86c73d3', onClick: this.onTimeWidget.bind(this) }, "Time Widget"), index.h("span", { key: 'fd935b97295f3fc10fbc96f4366aeed90f26582e', onClick: () => { this.vodTog.emit(); } }, "Toggle Video"), index.h("span", { key: 'd5343aa8765831b5b6f140c5a8aab475d02998a0', onClick: () => { this.wxccAuthPop.emit(); } }, "Authorization")), index.h("span", { key: '5512d14e8e093411dd26b2589a82d7eb73673118', class: "btn", id: "guide", onClick: this.onToggleGuide.bind(this) }, "Guide"), index.h("span", { key: 'f960bec77f358d038dacefc8f7baf344f3ae2d72', id: "next", onClick: this.onNext.bind(this), class: "nav btn" }, "Next")));
    }
};
