...
const SideDrawer = class {
    ...
    render() {
        let mainContent = this.content || index.h("slot", { key: '82a7fef75a1847ba3726b6e6e4f9180daaea8791' });
        if (this.showNav) {
            mainContent = index.h("ul", { key: '88173507f24abda89f56dacb906a850586a12c60', class: "nav" }, this.lessons.map(lesson => (index.h("li", { class: "nav", onClick: this.onChoice.bind(this, lesson.url) }, index.h("strong", null, lesson.title)))));
        }
        return [
            // <div class="backdrop" onClick={this.onCloseDrawer.bind(this)}/>,
            index.h("aside", { key: '452b4a3f026e9d92ccc1f269ea5099f86cf08dc1' }, index.h("header", { key: '8cb39b9d7e11904f89221b7c9383d5f7f5a172cf' }, index.h("h1", { key: '2d222b4d7b17c8434fd57cbfd0661afc5d315daf', class: "post-title" }, this.currentPage || this.arttitle)), index.h("section", { key: '9d1150859cf3a94b03060cbbd293e4d6972050cd', id: "tabs" }, index.h("button", { key: '9162613d149081a0723db18e50b6408dd62c4484', class: !this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "lesson") }, "Lesson"), index.h("button", { key: '49a3298c370fb8cf1c8beec397edcfc01227ca96', class: this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "nav") }, "Navigation")), index.h("main", { key: 'df39f0706d0980a7d252468259c44492751eb23f' }, mainContent))
        ];
    }
};
