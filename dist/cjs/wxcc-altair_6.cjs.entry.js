...
const SideDrawer = class {
    ...
    render() {
        let mainContent = this.content || index.h("slot", { key: 'eb64168084102bd31bbedf80073fe00ed7f8200c' });
        if (this.showNav) {
            mainContent = index.h("ul", { key: '1e353be0c55037a40da74e2f724c52fcbe248822', class: "nav" }, this.lessons.map(lesson => (index.h("li", { class: "nav", onClick: this.onChoice.bind(this, lesson.url) }, index.h("strong", null, lesson.title)))));
        }
        return [
            // <div class="backdrop" onClick={this.onCloseDrawer.bind(this)}/>,
            index.h("aside", { key: 'd859f13f969e9f8b6a7bcb0770da387fd5ee8a3c' }, index.h("header", { key: 'e0794cb4fcae971a708e0ec4bce6c2b27b4585d3' }, index.h("h1", { key: 'ffeeb8d36476dc32d94f47e25bf0a119da167bda', class: "post-title" }, this.currentPage || this.arttitle)), index.h("section", { key: '48414f20dcfd58ec5b80097986664258b45f8f63', id: "tabs" }, index.h("button", { key: '1dd4af9d1050dfe8b7693af33a709a13e07088d6', class: !this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "lesson") }, "Lesson"), index.h("button", { key: '2579e02395231dd4ee87b312e3a0fce5b1d280b1', class: this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "nav") }, "Navigation")), index.h("main", { key: 'fb1acdf703693aebc00131e19b51ed8797488f0a' }, mainContent))
        ];
    }
};
...
const PageControls = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c330ccb4b877fe57dd1f559c5ac0c24d92cad815', class: "controls" }, index.h("span", { key: 'c6a56a22234cc05eacd342cec729909cd8642e0f', id: "back", onClick: this.onBack.bind(this), class: "nav" }, "Back"), index.h("span", { key: '2c5b492d362ad50c5ad54db9112391b3ea0638b5', id: "tools", class: "mag" }, "Tools"), index.h("div", { key: '69c47c3712bb33216791a022f375c43d9466ca73', class: "tools" }, index.h("span", { key: '3a6b1e74038d213e6eef006a8cf8987b1061da09', onClick: this.onTimeWidget.bind(this) }, "Time Tool"), index.h("span", { key: 'b7458b7c177e06f9d6fcd04de2b9553c55bbe107', onClick: () => { this.vidPop.emit(); } }, "Show Video"), index.h("span", { key: '8fbc4e1efdb4464b16b79b5978c5ffcafcb0f7c7', onClick: () => { this.wxccAuthPop.emit(); } }, "Authorization")), index.h("span", { key: '541a3de47cf3cd8d937820c3d083d3738c7997c4', id: "guide", onClick: this.onToggleGuide.bind(this) }, "Guide"), index.h("span", { key: 'c9f87a06de1f93fa518aa72a7f20866fbb7a2501', id: "next", onClick: this.onNext.bind(this), class: "nav" }, "Next")));
    }
};
...
const wxccTime = class {
    ...
    render() {
        const hideIcon = index.h("svg", { key: 'a9aed2d4c02b44400a1b2790c0e3cfdb6a01be69', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 640 512" }, index.h("path", { key: '096c500be383ed7fa6ef7f4c212cac637ee14a3c', d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zm151 118.3C226 97.7 269.5 80 320 80c65.2 0 118.8 29.6 159.9 67.7C518.4 183.5 545 226 558.6 256c-12.6 28-36.6 66.8-70.9 100.9l-53.8-42.2c9.1-17.6 14.2-37.5 14.2-58.7c0-70.7-57.3-128-128-128c-32.2 0-61.7 11.9-84.2 31.5l-46.1-36.1zM394.9 284.2l-81.5-63.9c4.2-8.5 6.6-18.2 6.6-28.3c0-5.5-.7-10.9-2-16c.7 0 1.3 0 2 0c44.2 0 80 35.8 80 80c0 9.9-1.8 19.4-5.1 28.2zm51.3 163.3l-41.9-33C378.8 425.4 350.7 432 320 432c-65.2 0-118.8-29.6-159.9-67.7C121.6 328.5 95 286 81.4 256c8.3-18.4 21.5-41.5 39.4-64.8L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5zm-88-69.3L302 334c-23.5-5.4-43.1-21.2-53.7-42.3l-56.1-44.2c-.2 2.8-.3 5.6-.3 8.5c0 70.7 57.3 128 128 128c13.3 0 26.1-2 38.2-5.8z" }));
        return [
            index.h("div", { key: 'f761823afa01286a6ee70b7472541145972f6cfb', class: "frame" + (this.hide ? " hidden" : "") }, index.h("header", { key: '129507c17f76a9e89dd4f8bf8fdf329934d5e170' }, index.h("span", { key: 'c4fb5790ab685437c75d6a14c10ca2f1f01a2016', class: "hideMe", onClick: this.onToggle.bind(this) }, hideIcon), index.h("div", { key: 'bcf7da6f416978248ce1c2e4bbd144e0e412282f', class: "title" }, "Time Widget")), index.h("section", { key: 'b1e35dd41960216a6e7a7658a04ce499e60b5268', class: "widgets" }, index.h("div", { key: '82d1ffd161c6d9bcaacbf6189238016d7c15560d' }, index.h("label", { key: '0faf8a632e10a188201a0d5b71f05c58db27c59a', id: "from" }, "From: "), index.h("input", { key: '5a531e463271153b51426eee63f4c4160d046aab', type: "date", onChange: this.onManSet.bind(this, "from"), ref: el => this.fDate = el }), index.h("input", { key: '5002141fea24ccc594e38aa81030b4cfa772d290', type: "time", onChange: this.onManSet.bind(this, "from"), ref: el => this.fTime = el }), index.h("select", { key: '20281f8797885bc005bc433c74c7886567081bc3', ref: el => this.fromSelected = el, onChange: this.onToSelect.bind(this, "from") }, index.h("option", { key: '297c4b2b552ec6124d03e8841acb2cd631c0a3c0' }), index.h("option", { key: 'ea80009d0dae3ac6d93bbaf05b03ab8651c83a1e', value: "600000" }, "10 minutes ago"), index.h("option", { key: '89d3b0f6a59559be1012fb0c856c0f6b8b4d24ee', value: "3600000" }, "1 hour ago"), index.h("option", { key: '78435478e0360359c1325b6f71061ead1c9700c9', value: "86400000" }, "1 day ago"), index.h("option", { key: '5719a4c7d48c4d5bdedff7ada315d8d11857ec7d', value: "604800000" }, "1 week ago"))), index.h("br", { key: 'bff8e3586291b6d73b1f601d6e5b345a12959350' }), index.h("div", { key: '8fe94c0d82781ef00d0337f5cc3b2ab3852820af' }, index.h("label", { key: 'c87acae309a9841e60d9c1478c283486c10f014a', id: "to" }, "To: "), index.h("input", { key: '475304ec1de471c22b1c4822b2bc98f01f43a7fc', type: "date", onChange: this.onManSet.bind(this, "to"), ref: el => this.tDate = el }), index.h("input", { key: '260bcc4c531097e0ba5cfbefdbe2825d84fed729', type: "time", onChange: this.onManSet.bind(this, "to"), ref: el => this.tTime = el }), index.h("select", { key: 'db3616750f6203bc5b61a67273d565edeb43ca53', ref: el => this.toSelected = el, onChange: this.onToSelect.bind(this, "to") }, index.h("option", { key: 'b6b64cef2003cb6f4e3546970a3aca7611b7b1a7' }), index.h("option", { key: 'e478c3e06f9cc3fd1223ff2ae07d3f8a532a5b20', value: "now" }, "Now"), index.h("option", { key: 'bc7a812434cdf236d1675af714a11dc3c7eafd10', value: "600000" }, "10 minutes ago"), index.h("option", { key: 'a1dcded76bb75a7da2a0b86571ce0f4a6572a9d3', value: "3600000" }, "1 hour ago"), index.h("option", { key: '91d3ca3985c51c1797d6fd0eb17a5c2d8d73a839', value: "86400000" }, "1 day ago"), index.h("option", { key: 'e90390275678de997f0045853cb01f7b658d41f9', value: "604800000" }, "1 week ago")))), index.h("br", { key: '210162dba2b1b5847eb359c33cf01fac57a73ad3' }), index.h("section", { key: '96675969a674843d6915a3eac7282014aabbebc1' }, index.h("p", { key: 'f633ef2a0e598b430300b820978b2d141446f8a6' }, "from: \"", this.from, "\"", index.h("br", { key: 'b39ff2ef959d3c3b64bd7510d49110c1fa8ce5fb' }), "to: \"", this.to, "\"")))
        ];
    }
};
...
const wxccVideoModal = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '7c581c91feb1a143e330cd5956d02d6f5607d7e0', id: "cover", class: this.backDrop ? "covered" : "" }),
            index.h("div", { key: '68f38f707591cfb6dc60d60be7bb3b9b7abe367b', draggable: true, id: "my-div", ref: el => this.boxxie = el, onDragStart: () => { this.backDrop = true; }, onDragEnd: this.moveIt.bind(this), class: (this.vidBig ? "bigBoi" : "") + (this.hide ? " hidden" : "") }, index.h("div", { key: 'c8ee4d0f86177edcc69aeefb09eafd17bc0d0a69', id: "my-div-header" }, index.h("span", { key: '8d78a3eba45548e406e46cf4cc7bb370c930521d', class: "hideMe", onClick: this.onToggleHide.bind(this) }, index.h("svg", { key: '7879d7dd7851a9acd167b7ab9079f6d2ae072c88', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 640 512" }, index.h("path", { key: '74a9d00a62fdcdf97f9c76b731ade70fb286bc88', d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zm151 118.3C226 97.7 269.5 80 320 80c65.2 0 118.8 29.6 159.9 67.7C518.4 183.5 545 226 558.6 256c-12.6 28-36.6 66.8-70.9 100.9l-53.8-42.2c9.1-17.6 14.2-37.5 14.2-58.7c0-70.7-57.3-128-128-128c-32.2 0-61.7 11.9-84.2 31.5l-46.1-36.1zM394.9 284.2l-81.5-63.9c4.2-8.5 6.6-18.2 6.6-28.3c0-5.5-.7-10.9-2-16c.7 0 1.3 0 2 0c44.2 0 80 35.8 80 80c0 9.9-1.8 19.4-5.1 28.2zm51.3 163.3l-41.9-33C378.8 425.4 350.7 432 320 432c-65.2 0-118.8-29.6-159.9-67.7C121.6 328.5 95 286 81.4 256c8.3-18.4 21.5-41.5 39.4-64.8L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5zm-88-69.3L302 334c-23.5-5.4-43.1-21.2-53.7-42.3l-56.1-44.2c-.2 2.8-.3 5.6-.3 8.5c0 70.7 57.3 128 128 128c13.3 0 26.1-2 38.2-5.8z" }))), index.h("svg", { key: 'b516ec12c8400f102bc3c6bb343c2f969456f24e', id: "move", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: 'a39c345ba07bea0b79c8f1cb91bbc38c118ae6e7', d: "M278.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l9.4-9.4V224H109.3l9.4-9.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-9.4-9.4H224V402.7l-9.4-9.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-9.4 9.4V288H402.7l-9.4 9.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l9.4 9.4H288V109.3l9.4 9.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-64-64z" })), index.h("span", { key: '30c96d77a65a1e7dc8d2c2fd34b57bd647d5e5d6', class: "sizeBar", onClick: this.onToggleSize.bind(this) }, this.btnLable)), index.h("iframe", { key: '145e4233e3cde2a7e1f4e1282fa2c33cc9ca334b', src: url, height: "100%", width: "100%", frameborder: "0", loading: "lazy", allowFullScreen: true }))
        ];
    }
};
