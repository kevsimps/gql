...
const SideDrawer = class {
    ...
    render() {
        let mainContent = this.content || index.h("slot", { key: '310b3737906d6c8b16d9e7150ddb3528526693f5' });
        if (this.showNav) {
            mainContent = index.h("ul", { key: '866811467c9ee25aa346213beb34219c8a037ed9', class: "nav" }, this.lessons.map(lesson => (index.h("li", { class: "nav", onClick: this.onChoice.bind(this, lesson.url) }, index.h("strong", null, lesson.title)))));
        }
        return [
            // <div class="backdrop" onClick={this.onCloseDrawer.bind(this)}/>,
            index.h("aside", { key: '832a11c26c3e4c3c790ff1b9dfacc406e7d42cde' }, index.h("header", { key: '034b127df0ac34d943df822bc2436e3902244efd' }, index.h("h1", { key: '325443a4e9ea88eb0f25136927287f4a07e00d78', class: "post-title" }, this.currentPage || this.arttitle)), index.h("section", { key: '615f857307d0887d57987b1d664197b1a59f1fb5', id: "tabs" }, index.h("button", { key: 'b7d9ff42b35368a60fec017ba4a58ebb41cf5d19', class: !this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "lesson") }, "Lesson"), index.h("button", { key: '22fbf845fef340e7b760d00e83d454df74c1e22b', class: this.showNav ? "active" : "", onClick: this.onContentChange.bind(this, "nav") }, "Navigation")), index.h("main", { key: 'f15028aed9b1a8c23b15362ba29b2e2c4f2d2af9' }, mainContent))
        ];
    }
};
...
const PageControls = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '25e29195bcc21f14f1179de524360f437002c743', class: "controls" }, index.h("span", { key: 'a60df1fe885fba2e8c7c8719a776cdf1aecbc940', id: "back", onClick: this.onBack.bind(this), class: "nav" }, "Back"), index.h("span", { key: 'e82b1a952575375741280539c42e21f8a4a28b9d', id: "tools", class: "mag" }, "Tools"), index.h("div", { key: 'ed61bef223baa7718410532737c13f10625bd203', class: "tools" }, index.h("span", { key: '205e78ac0df8c827178f7102b601971a6c58de5f', onClick: this.onTimeWidget.bind(this) }, "Time Tool"), index.h("span", { key: '400c8dd1e74aae44ac41c9ca647dba9c6a1a8ccd', onClick: () => { this.vodTog.emit(); } }, "Show Video"), index.h("span", { key: '6ae523c7cd7b5b76ee9e916b3d0e1e6250a4816d', onClick: () => { this.wxccAuthPop.emit(); } }, "Authorization")), index.h("span", { key: '30dbeadcd5fe04ec23fa5bb0f954e9b5c0479d23', id: "guide", onClick: this.onToggleGuide.bind(this) }, "Guide"), index.h("span", { key: '7c95e3ffabf929c2f92415b0670786d9f70b1027', id: "next", onClick: this.onNext.bind(this), class: "nav" }, "Next")));
    }
};
